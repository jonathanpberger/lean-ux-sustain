...
This funny thing happens. Whenever we talk about Agile and Design, we talk about ways for designers to weather the Agile storm
...
I've only got 20m, so we're only going to talk about the first one here: Sclerosis around processes and tools.
...
# JPB: DO A TIME CHECK HERE. CAN I GET INTO OTHER STUFF? STRAIGHT INTO SUSTAINABLE PACE?
come in, reitierate the other three items
bust into "sus pace is the key"

---

We don't have time for the other 3:
- √ Right level of resolution via BDR
- Getting out of the deliverable bness
- Shared ownership
- Acceptance criteria

---

# INTERLUDE: How do we make space for the other 3?

---

## Fixed-bid *vs.* <br /> Time-and-Materials billing
(JPB: this is a shitty transition)
